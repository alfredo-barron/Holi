...
?>
	...
	<td align="left"> 
	    <img src=<?php echo $libro[0]['imagen']; ?> border="0" height="35" width="35"> 
    </td>   
	 
    <td align = left>
	
    <a href="detalles_libro.php?isbn=<?php echo $libro[0]['id_instrumento'];?>">
	<?php echo $libro[0]['descripcion'];?>				
	</a> 
	
    </td>
	
	<td align=center>
	<?php echo number_format($libro[0]['precio'],2); ?>
    </td>
	...
	<td align = center>
	<?php echo number_format($libro[0]["precio"] * $qty,2);?>
	</td>
