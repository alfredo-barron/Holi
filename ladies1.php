...
<div id="templatemo_main_wrapper">
	<div id="templatemo_main">
        ...
        <div class="gallery_box">
            <?php
                $re=mysql_query("select * from productos where id=4")or die(mysql_error());
        ...
        <div class="gallery_box no_margin_right">
        	 <?php
                $re=mysql_query("select * from productos where id=5")or die(mysql_error());
                while ($f=mysql_fetch_array($re)){
                 ?>
            <div class="col col_2">
            <a href="./productos/<?php echo $f['imagen'];?>" rel="lightbox[portfolio]"><img src="./productos/<?php echo $f['imagen'];?>" width= "300 px" height= "300 px" alt="Image 01" class="image_frame" /></a>
        ...
        <div class="gallery_box">
            <?php
                $re=mysql_query("select * from productos where id=6")or die(mysql_error());
                while ($f=mysql_fetch_array($re)){
                 ?>
            <div class="col col_2">
            <a href="./productos/<?php echo $f['imagen'];?>" rel="lightbox[portfolio]"><img src="./productos/<?php echo $f['imagen'];?>" width= "300 px" height= "300 px" alt="Image 01" class="image_frame" /></a>
        ...
        <div class="pagging">
            <ul>
                ...
                <li><a href="ladies2.php" target="_parent">Siguiente</a></li>
            </ul>
        </div>
