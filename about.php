...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
    <head>
        <title>Holi, Diseños</title>
       <meta name="keywords" content="accordion, about us, company, free css templates, web design, HTML" />
      <meta name="description" content="Accordion, About Us, Company, free CSS templates by templatemo.com" />
...
<script src="js/jquery.easing.1.3.js" type="text/javascript"></script>
    ...
    <div id="templatemo_main_wrapper">
        ...
        <div id="masthead" class="container clearfix">
            <h1>Diseñe su propio bolso usted misma!</h1>
        </div>

        <div id="demo" class="container clearfix"><br>
            <h2>Bolso Cielo Mezclilla</h2>
            <h3>A un solo color</h3>
            <p>Puedes ponerle el color que desees!!</p>
            <div class="product-preview">
                <div class="product">
                    <img src="./imagenes/bolso2.png" alt="Shirt Image" width="320px" />
                    <img id="mask" class="mask" src="./imagenes/bolso3.png" alt="Mask Image" width="320px"/>
                </div>

                <h3>Bolso Cielo Mezclilla</h3>
                <p>Mira impresionante</p>
                <h4>Escoge un color:</h4>
                <div class="swatch">
                    <a rel="255,255,255" href="#mask" title="Blanco">Blanco</a>
                    <a rel="32,223,95" href="#mask" title="Verde">Verde</a>
                    <a rel="255,211,8" href="#mask" title="Amarillo">Amarillo</a>
                    <a rel="255,101,8" href="#mask" title="Naranja">Naranja</a>
                    <a rel="16,200,255" href="#mask" title="Azul">Azul</a>
                    <a rel="142,8,255" href="#mask" title="Purpura">Purpura</a>
                    <a rel="245,25,45" href="#mask" title="Rojo">Rojo</a>
                </div>
            </div>
            <br><br>
         <!--   <h3>A 2 colores</h3>
            <p>Modifica tu bolso a 2 colores!!</p>
            <div class="product-preview">
                <div class="product">
                    <img src="./imagenes/bolso2.png" alt="Shirt Image" />
                    <img id="tt-mask" class="mask" src="./imagenes/bolso3.png" alt="Mask Image" />
            ...
            <p><a href="./index.php">Inicio</a> | Company Holi &copy;2014 </a></p>
        </div>
